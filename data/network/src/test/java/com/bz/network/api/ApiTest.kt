...
//    }
    ...
    @Test
    fun `getMovieDetails check json parsing using sample json`() =
        runTest {
    ...
    @Test
    fun `getNowPlayingMovies check json parsing using sample json`() =
        runTest {
    ...
    @Test
    fun `getPopularMoviePage check json parsing using sample json`() =
        runTest {
